...
import {
  ...
  updateCouponsClass,
  deleteCouponsClass
} from "../controller/CouponsClassController";
...
router.get("/couponclass", getAllCouponsClass);
router.get("/couponclass/:id", getCouponsClass);
router.post("/couponclass", createCouponsClass);
router.put("/couponclass/:id", updateCouponsClass);
router.delete("/couponclass/:id", deleteCouponsClass);
